...
public class Sky {
    private String info;  //天气名称
    private int icon;  //天气对应的图标
    private int bg;  //天气对应的背景

    private static HashMap<String,Sky> skyMap;
    static
        {
            skyMap = new HashMap<String, Sky>();
            ...
            skyMap.put("DUST",new Sky("浮沉", R.drawable.ic_fog,R.drawable.bg_fog));
        }
